...
function ENT:Initialize()
	...
	timer.Simple(1800, function() if self:IsValid() then self:Remove() tea_SystemBroadcast("Airdrop crate is gone!", Color(255,105,105,255), true) end end)
end
...
function ENT:Use(ply, caller)
	...
	if !self.Decoded and !self.Decoder then
		...
		timer.Simple(12, function() 
			...
			tea_SystemBroadcast(self.Decoder:Nick().." has opened an air drop crate!", Color(255,255,255,255), false)
			self.Decoded = true
