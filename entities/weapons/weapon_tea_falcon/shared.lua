...
SWEP.Author				= ""
SWEP.Contact			= ""
SWEP.Purpose			= "A classic pistol that has been in use for over 100 years and still stands tall on the battlefield"
...
SWEP.RunArmAngle = Vector(-7.269, 8.809, -9.631)