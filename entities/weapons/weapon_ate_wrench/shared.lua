...
SWEP.Instructions   = "This wrench is necessary to build unbuilt props and repair damaged props.  Becomes more effective if you level your engineer skill.  You can also use it as a bashing weapon but it isn't very effective."
...
function SWEP:DealDamage( anim )
	...
	if tr.Entity:IsValid() && (tr.Entity:GetClass() == "prop_flimsy" or tr.Entity:GetClass() == "prop_strong" or SpecialSpawns[tr.Entity:GetClass()]) then
		if tr.Entity.IsBuilt == false then
			...
			if (tr.Entity:GetClass() == "prop_flimsy" and tr.Entity.BuildLevel >= 3) or (tr.Entity:GetClass() == "prop_strong" and tr.Entity.BuildLevel >= 5) or (SpecialSpawns[tr.Entity:GetClass()] and tr.Entity.BuildLevel >= 6) then
