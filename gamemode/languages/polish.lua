-- Polish Translations (not enough budget to translate properly)

translate.AddLanguage("pl", "Polish")

--HUD translations

LANG.health = "Zdrowie: %s / %s"
LANG.armor = "Pancerz: %s / %s"
LANG.money = "Pieniądze: %s"
LANG.level = "Poziom: %s"
LANG.prestige = "Pretiż: %s"
LANG.timesurvived = "Time Survived: %ss"
LANG.stamina = "Stamina: %s%%"
LANG.hunger = "Głód: %s%%"
LANG.thirst = "Pragnienie: %s%%"
LANG.fatigue = "Zmęczenie: %s%%"
LANG.infection = "Infekcja: %s%%"
LANG.battery = "Bateria: %s%% (%s%% max)"
LANG.bounty = "Nagroda?: %s"
LANG.pts = "Punkty Doświadczenia: %s"
LANG.xpgained = "Zdobyto %d XP! (Total: %d)"
LANG.cashgained = "Zdobyto %d Kasy! (Total: %d)"
...
LANG.pickup = "Wciśnij E aby to podnieść"
LANG.zspawnon = "Zombie spawning enabled"
LANG.zspawnoff = "Zombie spawning disabled"
LANG.ver_1 = "Ver. %s"
LANG.ver_2 = "Ver. %s (Tryb Debugowania)"
LANG.ver_3 = "Ver. %s (Tryb Debugowania (Zaawansowany))"
LANG.ver_4 = "Ver. %s (Tryb Debugowania (Eksperymentalny))"
LANG.ver_5 = "Ver. %s (Tryb Debugowania (True Debug Mode))"

--Context Menu

LANG.clearprops = "Clear my Props"
LANG.selfkill = "End your suffering"
LANG.refreshinv = "Odśwież Ekwipunek"
...
LANG.sb_sheet7 = "Osiągnięcia"
LANG.sb_sheet7_d = "See what is your next goal"
LANG.sb_sheet1_1 = "Moje umiejętności"
LANG.sb_sheet1_1_d = "Ulepsz swoje statystyki"
...
LANG.item_egg_d = "A raw egg. Restores 4% hunger, but dehydrates 1% thirst."
LANG.item_milk_n = "Old Milk"
LANG.item_milk_d = "An old milk. Restores 11% hunger and quenches 20% thirst."
LANG.item_soda_n = "Can of Softdrink"
LANG.item_soda_d = "An old pre apocalyptic softdrink, it even still has bubbles left in it! Restores 1% health points, 8% hunger, 35% thirst, 5% stamina and recovers 1% of sleep."
...
LANG.item_beerbottle_d = "Makes the apocalypse a bit more bearable. Restores 1% health points, 9% hunger, 5% thirst, but drains 15% stamina and gives 10% fatigue."
LANG.item_tinnedfood_n = "Tinned Rations"
LANG.item_tinnedfood_d = "A tin of god knows what, the label fell off a long time ago. Restores 3% health points, 20% hunger, but dehydrates 10% thirst."
LANG.item_potato_n = "Potato"
LANG.item_potato_d = "A potato, tastes awful raw but it's edible nonetheless. Restores 2% health points, 22% hunger, but dehydrates 8% thirst."
LANG.item_traderfood_n = "Trader's Special"
LANG.item_traderfood_d = "A box of rather dubious looking meat and ramen, prepared for you by your friendly local trader. Restores 4% health points, 47% Hunger, 4% stamina but dehydrates 15% thirst."
LANG.item_trout_n = "River Trout"
LANG.item_trout_d = "A tasty, fresh river trout. Restores 5% health points, 65% Hunger, but dehydrates 4% thirst."
LANG.item_melon_n = "Watermelon"
LANG.item_melon_d = "A fresh, tasty watermelon, fresh from the farming compounds up in the mountains. Restores 7% health points, 85% Hunger, 20% thirst and 3% stamina."
LANG.item_burger_n = "Cheez Burger"
LANG.item_burger_d = "Can i haz cheez burger? Restores 30% health points, 100% hunger and 15% thirst, 90% stamina and recovers 25% of sleep."
LANG.item_hotdog_n = "Hot Dog"
LANG.item_hotdog_d = "A Hot Dog. Restores 20% health points, 80% hunger, 10% thirst, 40% stamina and recovers 15% of sleep."
LANG.item_donut_n = "Donut"
LANG.item_donut_d = "A donut. Restores 2% health points, 25% hunger, 5% stamina and recovers 1% of sleep, but dehydrates 7% of thirst."
LANG.item_bed_n = "Bed"
