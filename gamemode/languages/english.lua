...
LANG.CanRespawnIn = "You can respawn in %d %s"
...
LANG.ItemCraftingDescription = "%s\n(%s: %s)\nRequired Items:\n%s"
...
LANG.Radio = "Radio"
LANG.Radio_d = "An old radio. It doesn't work anymore, but traders may pay money for this."
...
LANG.AdminGiveItemNegativeValues = "You can't give negative values with tea_sadmin_giveitem! Use tea_sadmin_removeitem instead."
LANG.AdminGiveItemNoValue = "Giving 0 items will not work! Use values other than 0."
LANG.AdminGiveItemTooMany = "You can't give yourself that many items!"
