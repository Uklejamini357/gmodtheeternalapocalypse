...
--------------------------Help Form------------------------------------
	...
	HelpForm.Paint = function(self, w, h)
		...
		draw.SimpleText("back. Health Regen function is also changed, it regenerates less hp. So you gotta carry", "TargetIDSmall", 10, 110, Color(155,155,155,255))
		draw.SimpleText("more meds. Same thing applies for Weight system. 37.4 kg as carry weight, +1.53kg per", "TargetIDSmall", 10, 130, Color(155,155,155,255))
		draw.SimpleText("Strength skill (by default). The way how you play this gamemode is also the same like in", "TargetIDSmall", 10, 150, Color(155,155,155,255))
		draw.SimpleText("After The End. Barter skill is nerfed, you get less cash for selling items to traders.", "TargetIDSmall", 10, 170, Color(155,155,155,255))
		draw.SimpleText("Bounty loss on death is more than in vanilla, most likely you drop cash between of", "TargetIDSmall", 10, 190, Color(155,155,155,255))
		draw.SimpleText("30-40% bounty. Also, minimum amount of players required for boss is reduced to 2", "TargetIDSmall", 10, 210, Color(155,155,155,255))
		draw.SimpleText("and for airdrop is increased to 5. In addition, Prestiging system is added.", "TargetIDSmall", 10, 230, Color(155,155,155,255))
		draw.SimpleText("For more info about prestige, hold C and press 'Prestige'", "TargetIDSmall", 10, 250, Color(155,155,155,255))
		draw.SimpleText("General help:", "TargetIDSmall", 10, 275, Color(155,155,255,255))
