...
draw.SimpleText( "likely you lose 65% of bounty and drop 35%. Also, minimum amount of players required for", "TargetID", 15, 210, Color(155,155,155,255) )
...
draw.SimpleText( "F2 (gm_showteam): [Function Not Implemented]", "TargetID", 15, 400, Color(155,255,255,255) )
