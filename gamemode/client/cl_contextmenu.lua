...
--	surface.SetDrawColor(100, 100, 100 ,205)
	...
	NukeButton:SetText(translate.Get("ClearmyProps"))
	...
	PrestigeButton:SetText(translate.Get("Prestige"))
	...
	SuicideButton:SetPos( x + 175, y + 125)
	SuicideButton:SetText(translate.Get("Killself"))
	...
	draw.RoundedBox( 2, 0, 0, SuicideButton:GetWide(), SuicideButton:GetTall(), Color(50, 0, 0, 130) )
	end
	...
	CashButton:SetText(translate.Get("DropMoney"))
...
local WantToPrestigeFrame = vgui.Create( "DFrame" )
	...
	doprestige:SetText(translate.Get("DoPrestige"))
