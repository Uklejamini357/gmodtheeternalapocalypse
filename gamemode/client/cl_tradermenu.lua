...
function TraderMenu()
	...
	LWeight = vgui.Create( "DLabel", TraderFrame )
	...
	LMoney = vgui.Create( "DLabel", TraderFrame )
	...
	LVaultWeight:SetSize(350,25)
	LVaultWeight:SetText("Vault Capacity: "..CalculateVaultClient().."kg / "..GAMEMODE.Config["VaultSize"].."kg")
	LVaultWeight:SetPos(TraderFrame:GetWide() - (LVaultWeight:GetWide() - 80), TraderFrame:GetTall() - 42)
