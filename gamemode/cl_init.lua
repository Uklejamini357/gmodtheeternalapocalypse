...
print("Defense Skill: Increases total protection by 1.5% per level.")
print("Endurance Skill: Decreases stamina loss while sprinting and underwater per level and decreases stamina loss while landing by 4%.")
...
print("PvP Help:")
print("")
print("Has killing zombies over and over for you became so boring?")
print("Guess what! There is an alternative! PvP! PLAYER VERSUS PLAYER!")
print("PvP system is different here. When you toggle PvP, you will have 5 seconds of forced PvP.")
print("During that time, everyone except your faction mates will be able to kill you.")
print("")
end
