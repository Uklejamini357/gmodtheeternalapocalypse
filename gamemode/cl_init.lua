...
print("")
print("Once you pick up ANY of the loot mentioned above, excluding opening airdrop caches, a message will be broadcasted in chat.")
end
...
print("Damage Skill: Increases damage dealt against players by 2.5% per level.")
