...
if ((CalculateWeight(ply) + item["Weight"]) > (37.4 + ((ply.StatStrength or 0) * 1.53))) then SystemMessage(client, "You don't have enough space for that!", Color(255,205,205,255), true) return end
