...
function BootFromFaction( ply, target )
	...
	if ply:Team() == 1 or target:Team() == 1 then SystemMessage(ply, "You can't kick a loner!", Color(255,205,205,255), true) return false end -- how in the world did they manage to kick somebody if they are a loner
	...
	SystemMessage(target, ply:Nick().." has kicked you out from the faction!", Color(255,205,205,255), true)
	net.Start("RecvFactions")
	net.WriteTable(Factions)
	net.Broadcast()
end
