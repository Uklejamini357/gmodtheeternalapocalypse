...
StatsListServer =
{
	"StatDefense;Defense;2.5% Damage Reduction from zombies",
	"StatDamage;Damage;2.5% Attack bonus",
	"StatSpeed;Speed;+3.5 walkspeed, +7 runspeed",
	"StatHealth;Health;+ 5Hp",
	...
	"StatBarter;Barter;+1.5% cheaper stuff, +1.5% money gain for selling stuff",
