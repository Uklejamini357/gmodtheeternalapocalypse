...
function GM:CallPerksMenu()
	...
	hoverdesc:SetFont("TEA.HUDFontSmall")
	...
	for k, v in SortedPairsByMemberValue(GAMEMODE.PerksList, "PrestigeReq") do
		...
		perkdesc:SetFont("TEA.HUDFontSmall")
		...
		perkcost:SetFont("TEA.HUDFontSmall")
		...
		perkprestige:SetFont("TEA.HUDFontSmall")
