...
LANG.Engineer_d = "Increases repairing HP for props by 3HP. Also decreases prop cost by 2%.\nIncreases max armor by 2 and increases effectiveness of armor-reinforcing items by 2%." -- Edited
LANG.Endurance = "Endurance"
LANG.Endurance_d = "Decreases stamina reduction from motion by 2.8%, prolongs oxygen by 2%." -- Edited
...
LANG.weapon_tea_sweeper_d = "A 12 gauge pump shotgun that was commonly used by police and sport shooters before the apocalypse. Uses shotgun ammo." --same text as M3Enforcer_d
