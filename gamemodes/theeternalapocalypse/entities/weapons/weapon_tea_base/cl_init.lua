...
language.Add("ammo_127_ammo", "12.7mm Rounds")
language.Add("ammo_300_ammo", ".300 Magnum")
language.Add("ammo_338_ammo", ".338 Magnum")
language.Add("ammo_45_ammo", ".45ACP Rounds")
language.Add("ammo_50_ammo", ".50 AE Rounds")
language.Add("ammo_556x39_ammo", "5.45x39mm Rounds")
language.Add("ammo_556x45_ammo", "5.56x45mm Rounds")
language.Add("ammo_762_ammo", "7.62x39mm Rounds")
language.Add("ammo_c4_ammo", "C4 Explosives")
