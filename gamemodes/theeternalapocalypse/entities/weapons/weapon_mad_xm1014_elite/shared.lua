...
SWEP.VElements = {
	["drum"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(0, -1.551, -5.243), angle = Angle(0, 0, 0), size = Vector(0.112, 0.112, 0.057), color = Color(70, 70, 70, 255), surpresslightning = false, material = "", skin = 3, bodygroup = {} }
}

SWEP.WElements = {
	["drum"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(11.73, 0.912, -2.023), angle = Angle(80.939, 0, 0), size = Vector(0.18, 0.18, 0.109), color = Color(70, 70, 70, 255), surpresslightning = false, material = "", skin = 3, bodygroup = {} }
}