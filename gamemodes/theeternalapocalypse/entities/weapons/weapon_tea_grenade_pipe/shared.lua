...
SWEP.Primary.Ammo			= "nade_pipebombs"
...
SWEP.GrenadeType			= "ent_tea_grenade_pipe"
SWEP.GrenadeName			= "weapon_zw_grenade_pipe"
SWEP.GrenadeTime			= "3.5"
SWEP.CookGrenade			= true
SWEP.ThrowForce				= 800

SWEP.VElements = {
	["fuse"] = { type = "Model", model = "models/props_lab/pipesystem02e.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(-0.718, -1.843, -1.106), angle = Angle(-35.555, 16.53, 91.862), size = Vector(0.214, 0.214, 0.214), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["pipe"] = { type = "Model", model = "models/props_lab/pipesystem03a.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.639, 2.687, -0.285), angle = Angle(5.543, 14.446, -3.552), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["pipe"] = { type = "Model", model = "models/props_lab/pipesystem03a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.558, 1.121, -0.972), angle = Angle(0.082, -36.248, -70.479), size = Vector(0.587, 0.587, 0.587), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["fuse"] = { type = "Model", model = "models/props_lab/pipesystem02e.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.746, 0.104, -6.631), angle = Angle(6.159, -7.261, 17.549), size = Vector(0.214, 0.214, 0.214), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
