...
SWEP.VElements = {
	["cloth"] = { type = "Model", model = "models/props_junk/garbage_glassbottle002a_chunk01.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(-0.477, -2.135, -0.826), angle = Angle(10.241, 14.526, 78.102), size = Vector(0.19, 0.19, 0.19), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["pipe"] = { type = "Model", model = "models/props_junk/garbage_glassbottle003a.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.639, 2.451, -0.203), angle = Angle(8.737, 14.446, -97.222), size = Vector(0.61, 0.61, 0.61), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["fuse"] = { type = "Model", model = "models/props_junk/garbage_glassbottle002a_chunk01.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.522, 2.003, -6.316), angle = Angle(20.097, -2.375, 4.012), size = Vector(0.308, 0.308, 0.308), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["pipe"] = { type = "Model", model = "models/props_junk/garbage_glassbottle003a.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.517, 1.978, -1.558), angle = Angle(23.207, 6.268, 180), size = Vector(0.83, 0.83, 0.83), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:ThrowGrenade()
	...
	if self.CookGrenade and not self.Owner:GetNetworkedBool("Cooked") then
		...
		self.Weapon:EmitSound("ambient/fire/mtov_flame2.wav", 60)
	end
